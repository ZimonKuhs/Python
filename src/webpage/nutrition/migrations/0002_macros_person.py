# Generated by Django 3.2.5 on 2021-07-13 12:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kCal', models.DecimalField(decimal_places=3, max_digits=8)),
                ('carbs', models.DecimalField(decimal_places=3, max_digits=8)),
                ('fat', models.DecimalField(decimal_places=3, max_digits=8)),
                ('protein', models.DecimalField(decimal_places=3, max_digits=8)),
                ('fiber', models.DecimalField(decimal_places=3, max_digits=8)),
